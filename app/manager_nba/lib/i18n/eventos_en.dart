...
class EventosEn extends TextosDeEventos {
  ...
  Map<String, TextoDeEvento> get eventos => const {
        'cena_de_equipo': TextoDeEvento(
          titulo: 'Team dinner',
          texto: 'The veterans want to put together a dinner for the whole '
        ...
        'bronca_en_el_entrenamiento': TextoDeEvento(
          ...
          texto: 'Two players went from words to shoving during a five-on-five. '
        ...
        'estrella_pide_descanso': TextoDeEvento(
          ...
          texto: 'He has been playing through soreness since November. He is '
        ...
        'joven_pide_minutos': TextoDeEvento(
          ...
          texto: 'One of your kids has spent half a season glued to the bench. '
        ...
        'prensa_dura': TextoDeEvento(
          ...
          texto: 'After the last loss, the city paper ran a piece saying the '
        ...
        'racha_buena': TextoDeEvento(
          ...
          texto: 'The team is rolling and people are starting to talk about you '
        ...
        'aficion_llena_el_pabellon': TextoDeEvento(
          ...
          texto: 'Tickets are running out and the fans want something back: an '
        ...
        'acto_publicitario': TextoDeEvento(
          ...
          texto: 'A local brand is putting money on the table for a full day of '
        ...
        'partido_benefico': TextoDeEvento(
          ...
          texto: 'City hall is organising a charity exhibition and wants the '
        ...
        'viaje_infernal': TextoDeEvento(
          ...
          texto: 'The schedule has left you a brutal trip. The strength coach '
        ...
        'veterano_de_vestuario': TextoDeEvento(
          ...
          texto: 'The oldest man on the roster asks for five minutes with the '
        ...
        'recta_final': TextoDeEvento(
          ...
          texto: 'Few games left and everything is tight. The staff is asking '
        ...
        'rumor_de_traspaso': TextoDeEvento(
          ...
          texto: 'A reporter wrote that you are listening to offers for one of '
        ...
        'tanking_de_la_directiva': TextoDeEvento(
          ...
          texto: 'The math does not add up for the playoffs and upstairs they '
        ...
        'jugador_llega_tarde': TextoDeEvento(
          ...
          texto: 'Third time this month he has walked in after practice '
        ...
        'camiseta_de_una_leyenda': TextoDeEvento(
          ...
          texto: 'The club wants to raise his jersey to the rafters this '
        ...
        'entrenador_pide_mando': TextoDeEvento(
          ...
          texto: 'He wants to decide the rotation and the minutes himself, with '
        ...
        'metida_de_pata_en_redes': TextoDeEvento(
          ...
          texto: 'He posted at three in the morning that the officials are out '
        ...
        'precio_de_las_entradas': TextoDeEvento(
          ...
          texto: 'The team is winning, the building is full, and ownership sees '
        ...
        'nutricionista': TextoDeEvento(
          ...
          texto: 'He wants to rebuild the club’s food from the ground up: new '
