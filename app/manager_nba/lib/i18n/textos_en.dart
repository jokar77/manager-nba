...
class TextosEn extends Textos {
  ...
  @override
  String get fechaLimiteTraspasosPasada => 'The trade deadline has already passed: no more deals can be closed this season.';
  ...
  @override
  String get sinConQueConvencerles => "You don't have anything convincing to offer right now: neither your roster nor your picks are enough without leaving you short.";
  ...
  @override
  String get enhorabuenaAnillo => "Congratulations! You've done it: the ring is yours. Next season you'll have to defend it.";
  @override
  String get enhorabuenaCup => "Congratulations! You've won the NBA Cup. The ring is a different story: the season goes on.";
  @override
  ...
  @override
  String seJugaranDeUnaVez(int partidos, int dia, int mes) => 'All $partidos games you have left until $mes/$dia will be played at once.';
  @override
  ...
  @override
  String get descEventoFinAgenciaLibre => 'From here on, free agents can no longer be signed.';
  @override
  String get descEventoFechaLimiteTraspasos => 'Last day to make trades this season.';
  @override
  String get descEventoAllStar => "You don't have a game this weekend. Take the chance to check the Standings.";
  @override
  List<String> get nombresMeses => ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
  @override
  List<String> get diasSemanaAbrev => ['M', 'T', 'W', 'T', 'F', 'S', 'S'];
  @override
  String get unPartido => '1 game';
  @override
  ...
  @override
  String get noClasificasteAPlayoffs => "You didn't make the playoffs this season.";
  @override
  String get simularPlayoffsCompletos => 'Simulate full playoffs';
  @override
  String get serieDecididaFaltaResto => 'Your series is decided — the rest of the bracket needs to play out to know your next opponent.';
  @override
  String get simularRestoDeRonda => 'Simulate rest of the round';

  @override
  String ofertaTitulo(int n) => n == 1 ? "You've got an offer" : 'You have offers';
  @override
  String ofertaMensaje(int n) => n == 1 ? 'A team has asked about one of your players and put a proposal on the table.' : '$n teams have asked about your players.';
  @override
  String get masTarde => 'Later';
  @override
  String verOfertaBoton(int n) => n == 1 ? 'View offer' : 'View offers';
  @override
  String get preguntaSeguirSimulando => "You've reached this deadline of the season. Keep simulating, or stop to make moves?";
  @override
  ...
  String resultadoAllStar(
      ...
      String? mvp}) => 'The All-Star Game has been played. ${esteGana ? "The East" : "The West"} takes it $local-$visitante.${mvp == null ? "" : "\n\nGame MVP: $mvp."}';
  @override
  String get verFinDeSemana => 'View the weekend';
  @override
  String finalCupProgramada(String fecha) => "You're through to the NBA Cup Final! You play it on $fecha: simulate up to that day.";
  @override
  ...
  @override
  String get playoffsSeSiembranAlTerminar => 'The playoffs are seeded once your regular season (82 games) is over.';
  @override
  ...
  @override
  String get primeraRondaEsperaPlayIn => "The first round doesn't start until the Play-in decides who gets the 7 and 8 seeds.";
  @override
  ...
  @override
  List<String> get nombresDeRondaBracket => ['First\nround', 'Semifinals', 'West\nFinal', 'NBA\nFINALS', 'East\nFinal', 'Semifinals', 'First\nround'];
  @override
  ...
  @override
  String despedirConTiempoRestante(int anios, String importe) => "He has $anios ${anios == 1 ? 'season' : 'seasons'} left on his contract and you have to pay them anyway: $importe you WON'T be able to spend on his replacement until then.";
  @override
  String get despedirSinContrato => "He'll become a free agent and can sign with any team. Until you hire someone else, your team will play without a coach.";
  @override
  ...
  @override
  String get sePuedeOfertarPeroTrabajo => 'You can make them an offer, but they have a job: it takes a lot more to convince them, and the team you poach them from will look for a replacement right away.';
  @override
  String get avisoObligatorioTexto => "You can't play without a coach. Sign someone to continue: if no one convinces you or the budget doesn't allow it, you can always sign one for the minimum.";
  @override
  String mediaDeTuEquipoEs(int n) => "Your team's average is $n. The better a coach is, the better a project he demands — and money only covers part of the difference.";
  @override
  String pideAlAnioYTemporadas(String importe, int anios) => 'Wants $importe a year and $anios seasons.';
  @override
  String noLlegaMasaSalarial(String importe) => "You don't have enough cap space: you can only offer $importe.";
  @override
  String get tuEntrenadorLabel => 'Your coach';
  @override
  String get masaSalarialConBanquillo => 'Payroll (including bench)';
  @override
  String get porEncimaDelTopeSoloMinimo => "You're over the cap: you can only sign for the minimum salary.";
  @override
  String get sueldoEntrenadorCuentaEnMasa => "The coach's salary counts toward your payroll: what you spend here you don't have for players.";
  @override
  String contratoResumen(String importeAlAnio, String duracion) => '$importeAlAnio · $duracion contract';
  @override
  String trayectoriaEstaTemporada(int victorias, int derrotas) => 'This season: $victorias-$derrotas';
  @override
  String temporadasDirigiendo(int n) => '$n seasons coaching';
  @override
  String anillos(int n) => n == 1 ? '1 ring' : '$n rings';
  @override
  String entrenadorDelAnio(int n) => n == 1 ? '1-time Coach of the Year' : '$n-time Coach of the Year';
  @override
  String dirigeAEquipo(String apodo) => 'Coaches $apodo';
  @override
  String pideImportePorAnios(String importe, int anios) => 'Wants $importe × $anios ${anios == 1 ? "year" : "years"}';
  @override
  String get noCabeEnPresupuesto => "Doesn't fit your coaching budget";
  @override
  String get proyectoLeQuedaLejos => 'Your project is too far from what he wants';
  @override
  String get asuPrecioNo => "At his asking price he'd say no; with more money, maybe";
  @override
  ...
  @override
  String descripcionHueco(bool esTitular, String nombrePosicion) => esTitular ? '$nombrePosicion starter' : '$nombrePosicion backup';
  @override
  ...
  @override
  String alineacionDeEquipo(String equipo) => 'Lineup: $equipo';
  @override
  ...
  @override
  String huecoConJugador(String etiqueta, String nombre, String posicion, int media) => '$etiqueta: $nombre ($posicion, overall $media)';
  @override
  String lesionConDetalle(String motivo, int partidos, String fecha) => '$motivo ($partidos games) — back on $fecha — the backup will play meanwhile';
  @override
  String get fueraDeSusDosPosiciones => 'Out of both his positions (will perform a bit worse)';
  @override
  ...
  @override
  String get sinPicksPropios => "You have no picks of your own left: you've traded them all away.";
  @override
  String get traspasadoATiPorOtroEquipo => 'Traded to you by another team';
  @override
  String get ataqueYDefensaTitulo => 'Attack and defense';
  @override
  ...
  @override
  String nombreConPosicionYMedia(String nombre, String posicion, int media) => '$nombre ($posicion, overall $media)';
  @override
  String yaAsignadoIntercambio(String descripcionHueco) => 'currently $descripcionHueco — they will swap';
  @override
  ...
  @override
  String get todosFiltro => 'All';
  @override
  String get tituloAgenciaLibre => 'Free agency';
  @override
  String get verTuPlantilla => 'View your roster';
  @override
  String get agenciaLibreCerrada => 'Free agency has closed for this season: the deadline has passed. You can keep browsing the market, but you cannot sign anyone until next year.';
  @override
  ...
  @override
  String get quePuedaPagar => 'I can afford';
  @override
  String get noQuedaNadieEnMercado => 'Nobody left on the market.';
  @override
  String get nadieEncajaConFiltro => 'Nobody on the market matches what you asked for. Try removing a filter.';
  @override
  String contadorAgentesLibres(int n) => '$n free agents';
  @override
  String contadorAgentesLibresFiltrado(int visibles, int total) => '$visibles of $total free agents (filters applied)';
  @override
  String get empezarLaTemporadaBtn => 'Start the season';
  @override
  String get completaLaPlantillaParaContinuar => 'Fill out the roster to continue';
  @override
  String plantillaAlCompletoConN(int n) => 'Full roster: $n players.';
  @override
  String plantillaDeMax(int n, int max) => 'Roster: $n of $max players.';
  @override
  String faltanFichajesParaMinimo(int n) => '$n more signings needed to reach the minimum.';
  @override
  String otrosEquiposJuegan(int max, int n, int atras) => 'The other 29 teams play with $max. You can start with $n, but you\'re $atras behind.';
  @override
  String sinRecambioEn(String lista) => 'No backup at: $lista.';
  @override
  String libresBajoElTope(String cantidad) => '$cantidad available under the cap.';
  @override
  ...
  @override
  String get ofertaImprobable => 'Very unlikely he accepts this: the salary, the years, or both fall short.';
  @override
  String get ofertaSePuedePensar => 'He might think it over; he\'s not fully convinced.';
  @override
  ...
  @override
  String get ningunContratoSeAcaba => 'No contracts are expiring: your roster stays locked in for another year.';
  @override
  String continuarConNAgenciaLibre(int n) => 'Continue ($n heading to free agency)';
  @override
  String porEncimaDelTope(String cantidad) => 'You\'re $cantidad over the cap: you can only offer minimum contracts.';
  @override
  String teQuedanBajoElTope(String espacio, String tope) => 'You have $espacio left under the $tope cap.';
  @override
  String get seAcaboLaNegociacion => 'Negotiation\nis over';
  @override
  String ofrecerConN(int n) => 'Offer ($n)';
  @override
  String subtituloRenovacion(String posicion, int edad, int media, String cobraba, String pide) => '$posicion · age $edad · overall $media\nWas earning $cobraba · asking $pide';
  @override
  String get cerramosElTraspaso => 'Close the trade?';
  @override
  String seVanYLlegan(String piden, String ofrecen) => '$piden leave and $ofrecen arrive.';
  @override
  String get tituloOfertasRecibidasScreen => 'Offers received';
  @override
  String get nadieTePideNadaAhora => 'Nobody has offered you anything right now. Keep simming: offers arrive during the season.';
  @override
  ...
  @override
  String contratoAnioMillones(String anios, String millones) => '$anios · $millones a year';
  @override
  ...
  @override
  String get fechaLimiteTraspasosNoMasOperaciones => 'The trade deadline has passed: no more deals can be closed this season.';
  @override
  ...
  @override
  String get ningunEquipoTeDariaNada => 'No team would give you anything worthwhile in return.';
  @override
  String get noTienesConQueConvencer => 'You have nothing to convince them with: neither your roster nor your picks get there without gutting you.';
  @override
  String get tituloTraspasos => 'Trades';
  @override
  String get fechaLimiteTraspasosBanner => 'The trade deadline has already passed this season: you can keep browsing the market, but can\'t close anything until next year.';
  @override
  ...
  @override
  String get yaHasPuestoTodo => 'You\'ve already put everything this team had on the table.';
  @override
  String get sacarDeLaOperacion => 'Remove from the deal';
  @override
  String get noCuadraMeteATerceroLarga => 'Doesn\'t add up?\nBring in a third team';
  @override
  ...
  @override
  String get mercadoCerradoNoSeBuscan => 'The market is closed: the trade deadline has passed. You can\'t search for deals until next year.';
  @override
  ...
  @override
  String get explicacionPuntuacionCarreraTooltip => 'What the career score means';
  @override
  ...
  @override
  String partidoNMarcador(int n, String local, int marcadorLocal, int marcadorVisitante, String visitante) => 'Game $n: $local $marcadorLocal - $marcadorVisitante $visitante';
  @override
  ...
  @override
  String noSePudieronCargarCamisetas(String error) => 'The retired jerseys couldn\'t be loaded.\n$error';
  @override
  String get todaviaNoHayCamisetaEnLiga => 'No jersey has been retired in the league yet. When a legend retires you\'ll be able to honor them.';
  @override
  String get franquiciaLabel => 'Franchise';
  @override
  String get todaLaLigaOpcion => 'Whole league';
  @override
  String equipoTodaviaNoHaRetirado(String equipo) => '$equipo hasn\'t retired any jersey yet.';
  @override
  String get tuEquipoBadge => 'YOUR TEAM';
  @override
  String get retiradaRealDeLaFranquicia => 'Real franchise retirement';
  @override
  String retiradaEnLaTemporada(String etiquetaTemporada) => 'Retired in $etiquetaTemporada';
  @override
  ...
  @override
  String noSePudieronCargarPremios(String error) => 'The awards couldn\'t be loaded.\n$error';
  @override
  ...
  @override
  String arrancaLaTemporada(int n, int anioInicio, int anioFin) => 'Season $n begins ($anioInicio-$anioFin)';
  @override
  String get plantillaHaCambiadoAviso => 'Your roster has changed: review it before the first game — an automatic lineup has been set for you.';
  @override
  String get tusEleccionesDelDraft => 'Your draft picks';
  @override
  String get seRetiranDeTuEquipo => 'Retiring from your team';
  @override
  String cuelgaLasBotasCon(int edad, int media) => 'Hangs it up at $edad, overall $media';
  @override
  ...
  @override
  String recibeA(String equipoA, String jugadorB, String posicionB) => '$equipoA gets $jugadorB ($posicionB)';
  @override
  String get tambienSeRetiran => 'Also retiring';
  @override
  String yNMas(int n) => 'and $n more';
  @override
  String posicionMediaSeparador(String posicion, int media) => '$posicion · overall $media · ';
  ...
  @override
  String seRetiraConEdadYMedia(String procedencia, int edad, int media, String aviso) => '$procedencia · retires at $edad, overall $media$aviso';
  @override
  String get suCamisetaYaRetiradaSola => ' · their jersey was already retired on its own (real legend)';
  @override
  ...
  @override
  String get eligiendoElRestoDeEquipos => 'The rest of the teams are picking...';
  @override
  ...
  @override
  String posicionEdadMedia(String posicion, int edad, int media) => '$posicion · age $edad · overall $media';

  @override
  String cuartosCopaSeSiembranAviso(String nbaCup) => 'The $nbaCup quarterfinals are seeded as soon as the group stage finishes across the whole league.';
  @override
  String get finalSeJuegaDesdeCalendarioAviso => 'The Final is played from the calendar: if you\'re a finalist, it\'s marked as just another day of your season.';
  @override
  ...
  @override
  String noSePudoCargarResumen(String error) => 'The summary couldn\'t be loaded.\n$error';
  @override
  String temporadaConEtiqueta(String etiqueta) => 'Season $etiqueta';
  @override
  String get pestanaBalance => 'Overview';
  @override
  String puestoEnConferencia(String conferencia) => 'Position in the $conferencia';
  @override
  ...
  @override
  String partidosJugadosVictoriasPct(int partidos, int pct) => '$partidos games · $pct% wins';
  @override
  String get todaviaNoHayClasificacion => 'No standings yet.';
  @override
  String get columnaPJ => 'GP';
  @override
  String posicionMedia(String posicion, int media) => '$posicion · overall $media';

  @override
  String get allStarSubtituloPendiente => 'Played during the February break. Sim forward to All-Star weekend to see it.';
  @override
  String get risingStarsSubtituloPendiente => 'The best rookies against second-year players, the same weekend.';
  @override
  String get votacionAbreCuandoRuedeBalonAviso => 'Voting opens once the ball starts rolling. As you play through the season you\'ll see who\'s earning a spot and by how many votes.';
  @override
  ...
  @override
  String get recuentoCerradoAviso => 'Count closed: these were the ones chosen.';
  @override
  String votacionAbiertaConPorcentaje(int pct) => 'Voting open, with $pct% of the season played. Keep simming and the votes will shift.';
  @override
  String get votacionFinalLabel => 'Final vote';
  @override
  String get votacionDeAficionadosLabel => 'Fan vote';
  @override
  String conferenciaConNombre(String conferenciaLabel) => '$conferenciaLabel Conference';
  @override
  ...
  @override
  String posicionValoracion(String posicion, String valoracion) => '$posicion · $valoracion rating';

  @override
  String get noLlegoACompletarNingunaTemporada => 'Never completed a full season with you.';
  @override
  ...
  @override
  String get sinTitulosNiPremiosCarreraNba => 'No titles or awards in his NBA career.';
  @override
  String get sinTitulosNiPremiosIndividuales => 'No titles or individual awards.';
  @override
  String resumenCarreraTotales(int temporadas, String posicion, int partidos) => '$temporadas seasons · $posicion · $partidos games';
  @override
  String totalesCarreraLinea(String pts, String ast, String reb) => 'Totals: $pts pts · $ast ast · $reb reb';
  @override
  String temporadasPreviasAviso(int n) => '$n of them before you took over: there are no stats for those, the averages below are from your era.';
  @override
  String get antesDeTuPartidaTitulo => 'Before your save';
  @override
  String temporadasYaJugadasCuandoCogisteElEquipo(int n) => '$n ${n == 1 ? 'season' : 'seasons'} already played by the time you took over the team.';
  @override
  String get produccionDeReferenciaAviso => 'His baseline production when the save started. There are no game-by-game stats from those years.';
  @override
  String sinEstadisticasDeCarreraAviso(String nombre) => 'There are no career stats for $nombre: he\'s from an era before the game\'s data coverage. His place in history is there, the numbers aren\'t.';
  @override
  String get suCarreraEnLaNbaReal => 'His real NBA career';
  @override
  String conEquipoEnLaNbaReal(String equipo) => 'With $equipo in the real NBA';
  @override
  String temporadasPartidos(int temporadas, int partidos) => '$temporadas seasons · $partidos games';
  @override
  String rangoTemporadasPartidos(String desde, String hasta, int partidos) => '$desde to $hasta · $partidos games';
  @override
  String rangoPartidos(String rango, int partidos) => '$rango · $partidos games';
  @override
  String temporadaMinuscula(int n) => 'season $n';

  @override
  String get nadieTePropuestoNadaAhora => 'Nobody has proposed anything to you yet';
  @override
  String get unEquipoQuiereAUnoDeTusJugadores => 'A team wants one of your players';
  @override
  String nEquiposHanPreguntado(int n) => '$n teams have asked about your players';
  @override
  String cuadroYResultadosDeLaCopa(String nbaCup) => '$nbaCup bracket and results';
  @override
  String get seDesbloqueaAlTerminarFaseDeGrupos => 'Unlocks once the group stage ends';
  @override
  String get premiosDeFinDeTemporadaSubtitulo => 'End-of-season awards';
  @override
  String get seDesbloqueaAlTerminarTemporadaRegular => 'Unlocks once the regular season ends';
  @override
  String get bracketDeEliminatorias => 'Playoff bracket';
  @override
  String hallOfFameYCamisetasRetiradasSubtitulo(String hallOfFame, String camisetas) => '$hallOfFame and $camisetas';
  @override
  ...
  @override
  String get eligeLaPartidaQueQuieresCargar => 'Choose the save you want to load';
  @override
  ...
  @override
  String get sePerderaEnteraAviso => 'That slot already has a career in progress and it will be lost entirely: rosters, calendar and honors. This can\'t be undone.';
  @override
  ...
  @override
  String sePierdeCarreraDeAviso(String nombre) => 'The whole $nombre career will be lost: rosters, calendar, honors, legends and retired jerseys. This can\'t be undone.';
  @override
  ...
  @override
  String jugadorConFicha(String nombre, String posicion, int media, int edad) => '$nombre ($posicion, $media, age $edad)';
  @override
