...
class EventosFr extends TextosDeEventos {
  ...
  Map<String, TextoDeEvento> get eventos => const {
        'cena_de_equipo': TextoDeEvento(
          ...
          texto: 'Les cadres veulent organiser un dîner pour tout l’effectif, '
        ...
        'bronca_en_el_entrenamiento': TextoDeEvento(
          ...
          texto: 'Deux joueurs sont passés des mots aux mains pendant un cinq '
        ...
        'estrella_pide_descanso': TextoDeEvento(
          titulo: 'Ton meilleur joueur demande à souffler',
          texto: 'Il joue avec des douleurs depuis novembre. Il n’est pas '
        ...
        'joven_pide_minutos': TextoDeEvento(
          titulo: 'Un jeune réclame du temps de jeu',
          texto: 'Un de tes jeunes passe la moitié de la saison scotché au '
        ...
        'prensa_dura': TextoDeEvento(
          ...
          texto: 'Après la dernière défaite, le journal de la ville a écrit que '
        ...
        'racha_buena': TextoDeEvento(
          ...
          texto: 'L’équipe est lancée et on commence à parler de vous comme '
        ...
        'aficion_llena_el_pabellon': TextoDeEvento(
          ...
          texto: 'Les billets partent et le public réclame un geste : un '
        ...
        'acto_publicitario': TextoDeEvento(
          ...
          texto: 'Une marque de la ville met de l’argent sur la table pour '
        ...
        'partido_benefico': TextoDeEvento(
          ...
          texto: 'La mairie organise un match de gala caritatif et veut '
        ...
        'viaje_infernal': TextoDeEvento(
          ...
          texto: 'Le calendrier a lâché un déplacement très dur. Le préparateur '
        ...
        'veterano_de_vestuario': TextoDeEvento(
          titulo: 'Un cadre propose de parler au groupe',
          texto: 'Le plus ancien de l’effectif te demande cinq minutes avec '
              'l’équipe, sans le staff. Il dit qu’il y a des choses '
              'qui se disent mieux entre joueurs.',
          opciones: {
        ...
        'recta_final': TextoDeEvento(
          ...
          texto: 'Il reste peu de matchs et tout est serré. Le staff demande '
        ...
        'rumor_de_traspaso': TextoDeEvento(
          titulo: 'Il a lu son nom dans les rumeurs',
          texto: 'Un journaliste a écrit que tu écoutes des offres pour un de '
              'tes titulaires. Il te pose la question en face, devant la '
              'moitié du vestiaire.',
          opciones: {
        ...
        'tanking_de_la_directiva': TextoDeEvento(
          ...
          texto: 'Les comptes ne mènent pas aux playoffs et en haut on '
        ...
        'jugador_llega_tarde': TextoDeEvento(
          titulo: 'Encore un retard',
          texto: 'Troisième fois ce mois-ci qu’il arrive après le début de '
        ...
        'camiseta_de_una_leyenda': TextoDeEvento(
          ...
          texto: 'Le club veut hisser son maillot sous le toit cette saison. La '
        ...
        'entrenador_pide_mando': TextoDeEvento(
          ...
          texto: 'Il veut décider lui-même de la rotation et des minutes, sans '
        ...
        'metida_de_pata_en_redes': TextoDeEvento(
          titulo: 'Un joueur a dérapé sur les réseaux',
          texto: 'Il a publié à trois heures du matin que les arbitres l’ont '
        ...
        'precio_de_las_entradas': TextoDeEvento(
          ...
          texto: 'L’équipe gagne, la salle se remplit, et la propriété voit le '
        ...
        'nutricionista': TextoDeEvento(
          ...
          texto: 'Il propose de refaire l’alimentation du club de fond en '
