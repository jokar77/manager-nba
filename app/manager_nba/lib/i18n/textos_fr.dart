...
class TextosFr extends Textos {
  ...
  @override
  String get fechaLimiteTraspasosPasada => 'La date limite des échanges est déjà passée : plus aucune opération ne peut être conclue cette saison.';
  ...
  @override
  String get sinConQueConvencerles => "Tu n'as rien d'assez convaincant à proposer pour l'instant : ni ton effectif ni tes picks ne suffisent sans t'affaiblir.";
  ...
  @override
  String get enhorabuenaAnillo => "Félicitations ! Vous l'avez fait : la bague est à vous. La saison prochaine, il faudra la défendre.";
  @override
  String get enhorabuenaCup => 'Félicitations ! Vous avez remporté la NBA Cup. La bague, c\'est une autre histoire : la saison continue.';
  @override
  ...
  @override
  String seJugaranDeUnaVez(int partidos, int dia, int mes) => 'Les $partidos matchs qu\'il te reste jusqu\'au $dia/$mes vont être joués d\'un coup.';
  @override
  ...
  @override
  String get descEventoFinAgenciaLibre => "À partir de maintenant, il n'est plus possible de signer des agents libres.";
  @override
  String get descEventoFechaLimiteTraspasos => 'Dernier jour pour faire des échanges cette saison.';
  @override
  String get descEventoAllStar => "Tu n'as pas de match ce week-end. Profites-en pour consulter le Classement.";
  @override
  List<String> get nombresMeses => ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre', 'Novembre', 'Décembre'];
  @override
  List<String> get diasSemanaAbrev => ['L', 'M', 'M', 'J', 'V', 'S', 'D'];
  @override
  String get unPartido => '1 match';
  @override
  ...
  @override
  String get noClasificasteAPlayoffs => "Tu ne t'es pas qualifié pour les playoffs cette saison.";
  @override
  String get simularPlayoffsCompletos => 'Simuler tous les playoffs';
  @override
  String get serieDecididaFaltaResto => 'Ta série est décidée — il faut attendre le reste du tableau pour connaître ton prochain adversaire.';
  @override
  String get simularRestoDeRonda => 'Simuler le reste du tour';

  @override
  String ofertaTitulo(int n) => n == 1 ? 'Tu as reçu une offre' : 'Tu as des offres';
  @override
  String ofertaMensaje(int n) => n == 1 ? "Une équipe s'est renseignée sur un de tes joueurs et a mis une proposition sur la table." : '$n équipes se sont renseignées sur tes joueurs.';
  @override
  String get masTarde => 'Plus tard';
  @override
  String verOfertaBoton(int n) => n == 1 ? "Voir l'offre" : 'Voir les offres';
  @override
  String get preguntaSeguirSimulando => "Tu as atteint cette date limite de la saison. Tu continues à simuler ou tu t'arrêtes pour faire des mouvements ?";
  @override
  ...
  String resultadoAllStar(
      ...
      String? mvp}) => 'Le All-Star Game a été joué. ${esteGana ? "L'Est" : "L'Ouest"} remporte la rencontre $local-$visitante.${mvp == null ? "" : "\n\nMVP du match : $mvp."}';
  @override
  String get verFinDeSemana => 'Voir le week-end';
  @override
  String finalCupProgramada(String fecha) => 'En route pour la finale de la NBA Cup ! Tu la joues le $fecha : simule jusqu\'à ce jour-là.';
  @override
  ...
  @override
  String get playoffsSeSiembranAlTerminar => 'Les playoffs se composent une fois ta saison régulière (82 matchs) terminée.';
  @override
  ...
  @override
  String get primeraRondaEsperaPlayIn => "Le premier tour ne commence pas tant que le Play-in n'a pas désigné le 7e et le 8e.";
  @override
  ...
  @override
  List<String> get nombresDeRondaBracket => ['Premier\ntour', 'Demi-finales', 'Finale\nOuest', 'FINALES\nNBA', 'Finale\nEst', 'Demi-finales', 'Premier\ntour'];
  @override
  ...
  @override
  String despedirConTiempoRestante(int anios, String importe) => "Il lui reste $anios ${anios == 1 ? 'saison' : 'saisons'} de contrat et il faut les payer quand même : $importe que tu ne pourras PAS dépenser sur son remplaçant tant qu'elles ne seront pas écoulées.";
  @override
  String get despedirSinContrato => "Il redeviendra libre et pourra signer avec n'importe quelle équipe. Tant que tu n'auras pas recruté quelqu'un d'autre, ton équipe jouera sans entraîneur.";
  @override
  String get ficharPorElMinimoBtn => 'Recruter au minimum';
  @override
  String get noHayEntrenadorSinEquipo => "Il n'y a aucun entraîneur sans équipe";
  @override
  String get dirigiendoAOtroEquipo => 'Entraîne une autre équipe';
  @override
  String get sePuedeOfertarPeroTrabajo => "Tu peux leur faire une offre, mais ils ont un emploi : il faut bien plus pour les convaincre, et l'équipe à qui tu le prends cherchera un remplaçant sur-le-champ.";
  @override
  String get avisoObligatorioTexto => "Tu ne peux pas jouer sans entraîneur. Recrute quelqu'un pour continuer : si personne ne te convainc ou que ton budget ne suit pas, tu peux toujours en recruter un au minimum.";
  @override
  String mediaDeTuEquipoEs(int n) => "Le niveau moyen de ton équipe est $n. Meilleur est un entraîneur, meilleur est le projet qu'il exige — et l'argent ne comble qu'une partie de la différence.";
  @override
  String pideAlAnioYTemporadas(String importe, int anios) => 'Demande $importe par an et $anios saisons.';
  @override
  String noLlegaMasaSalarial(String importe) => "Ta masse salariale ne suffit pas : tu ne peux proposer que $importe.";
  @override
  String get tuEntrenadorLabel => 'Ton entraîneur';
  @override
  String get masaSalarialConBanquillo => 'Masse salariale (banc inclus)';
  @override
  String get porEncimaDelTopeSoloMinimo => 'Tu es au-dessus du plafond : tu ne peux recruter qu\'au salaire minimum.';
  @override
  String get sueldoEntrenadorCuentaEnMasa => "Le salaire de l'entraîneur compte dans ta masse salariale : ce que tu dépenses ici, tu ne l'as plus pour les joueurs.";
  @override
  String contratoResumen(String importeAlAnio, String duracion) => '$importeAlAnio · contrat de $duracion';
  @override
  String trayectoriaEstaTemporada(int victorias, int derrotas) => 'Cette saison : $victorias-$derrotas';
  @override
  String temporadasDirigiendo(int n) => '$n saisons à entraîner';
  @override
  String anillos(int n) => n == 1 ? '1 bague' : '$n bagues';
  @override
  String entrenadorDelAnio(int n) => n == 1 ? "1 fois entraîneur de l'année" : '$n fois entraîneur de l\'année';
  @override
  String dirigeAEquipo(String apodo) => 'Entraîne $apodo';
  @override
  String pideImportePorAnios(String importe, int anios) => 'Demande $importe × $anios ${anios == 1 ? "an" : "ans"}';
  @override
  ...
  @override
  String get asuPrecioNo => 'À son prix, il dirait non ; avec plus d\'argent, peut-être';
  @override
  ...
  @override
  String descripcionHueco(bool esTitular, String nombrePosicion) => esTitular ? 'titulaire au poste de $nombrePosicion' : 'remplaçant au poste de $nombrePosicion';
  @override
  String get tituloTitular => 'Titulaire';
  @override
  String get tituloSuplente => 'Remplaçant';
  @override
  Map<String, String> get nombresDePosiciones => {'PG': 'Meneur (PG)', 'SG': 'Arrière (SG)', 'SF': 'Ailier (SF)', 'PF': 'Ailier fort (PF)', 'C': 'Pivot (C)'};
  @override
  ...
  @override
  String alineacionDeEquipo(String equipo) => 'Composition : $equipo';
  @override
  ...
  @override
  String huecoConJugador(String etiqueta, String nombre, String posicion, int media) => '$etiqueta : $nombre ($posicion, niveau $media)';
  @override
  String lesionConDetalle(String motivo, int partidos, String fecha) => '$motivo ($partidos matchs) — retour le $fecha — le remplaçant jouera en attendant';
  @override
  String get fueraDeSusDosPosiciones => 'Hors de ses deux postes (rendra un peu moins bien)';
  @override
  ...
  @override
  String get traspasadoATiPorOtroEquipo => 'Échangé vers toi par une autre équipe';
  @override
  String get ataqueYDefensaTitulo => 'Attaque et défense';
  @override
  ...
  @override
  String nombreConPosicionYMedia(String nombre, String posicion, int media) => '$nombre ($posicion, niveau $media)';
  @override
  String yaAsignadoIntercambio(String descripcionHueco) => 'actuellement $descripcionHueco — ils vont être échangés';
  @override
  String get tituloTusPicksDeDraft => 'Tes choix de draft';

  @override
  String lesionSimple(String motivo, String fecha) => '$motivo, retour le $fecha';
  ...
  @override
  String get agenciaLibreCerrada => 'L\'agence libre est fermée pour cette saison : la date limite est passée. Tu peux continuer à consulter le marché, mais plus signer personne avant l\'année prochaine.';
  @override
  String get completarConContratosMinimos => 'Compléter avec des contrats minimums';
  @override
  ...
  @override
  String get nadieEncajaConFiltro => 'Personne sur le marché ne correspond à ta demande. Essaie de retirer un filtre.';
  @override
  String contadorAgentesLibres(int n) => '$n agents libres';
  @override
  String contadorAgentesLibresFiltrado(int visibles, int total) => '$visibles agents libres sur $total (filtres actifs)';
  @override
  String get empezarLaTemporadaBtn => 'Démarrer la saison';
  @override
  String get completaLaPlantillaParaContinuar => 'Complète l\'effectif pour continuer';
  @override
  ...
  @override
  String faltanFichajesParaMinimo(int n) => 'Il manque $n recrues pour atteindre le minimum.';
  @override
  String otrosEquiposJuegan(int max, int n, int atras) => 'Les 29 autres équipes jouent à $max. Tu peux démarrer avec $n, mais tu es en retard de $atras.';
  @override
  String sinRecambioEn(String lista) => 'Pas de remplaçant à : $lista.';
  @override
  String libresBajoElTope(String cantidad) => '$cantidad disponibles sous le plafond.';
  @override
  ...
  @override
  String get ofertaImprobable => 'Très improbable qu\'il accepte comme ça : le salaire, les années, ou les deux sont insuffisants.';
  @override
  String get ofertaSePuedePensar => 'Il peut y réfléchir ; il n\'est pas totalement convaincu.';
  @override
  ...
  @override
  String get ningunContratoSeAcaba => 'Aucun contrat n\'expire : ton effectif reste engagé un an de plus.';
  @override
  String continuarConNAgenciaLibre(int n) => 'Continuer ($n partent en agence libre)';
  @override
  String porEncimaDelTope(String cantidad) => 'Tu es $cantidad au-dessus du plafond : tu ne peux offrir que des contrats minimums.';
  @override
  String teQuedanBajoElTope(String espacio, String tope) => 'Il te reste $espacio sous le plafond de $tope.';
  @override
  String get seAcaboLaNegociacion => 'Négociation\nterminée';
  @override
  String ofrecerConN(int n) => 'Offrir ($n)';
  @override
  String subtituloRenovacion(String posicion, int edad, int media, String cobraba, String pide) => '$posicion · $edad ans · niveau $media\nTouchait $cobraba · demande $pide';
  @override
  String get cerramosElTraspaso => 'On conclut l\'échange ?';
  @override
  String seVanYLlegan(String piden, String ofrecen) => '$piden partent et $ofrecen arrivent.';
  @override
  String get tituloOfertasRecibidasScreen => 'Offres reçues';
  @override
  String get nadieTePideNadaAhora => 'Personne ne te propose rien pour l\'instant. Continue à simuler : les offres arrivent en cours de saison.';
  @override
  ...
  @override
  String aniosDeContrato(int n) => '$n ans';
  @override
  String contratoAnioMillones(String anios, String millones) => '$anios · $millones par an';
  @override
  ...
  @override
  String get fechaLimiteTraspasosNoMasOperaciones => 'La date limite des échanges est passée : plus aucune opération ne peut être conclue cette saison.';
  @override
  ...
  @override
  String get ningunEquipoTeDariaNada => 'Aucune équipe ne te donnerait quelque chose qui en vaille la peine.';
  @override
  String get noTienesConQueConvencer => 'Tu n\'as pas de quoi les convaincre : ni ton effectif ni tes choix n\'y suffisent sans te ruiner.';
  @override
  String get tituloTraspasos => 'Échanges';
  @override
  String get fechaLimiteTraspasosBanner => 'La date limite des échanges est déjà passée cette saison : tu peux continuer à consulter le marché, mais rien conclure avant l\'année prochaine.';
  @override
  String get noCuadraMeteATercero => 'Ça ne colle pas ? Ajoute une troisième équipe';
  @override
  ...
  @override
  String get yaHasPuestoTodo => 'Tu as déjà mis sur la table tout ce que cette équipe avait de disponible.';
  @override
  String get sacarDeLaOperacion => 'Retirer de l\'opération';
  @override
  String get noCuadraMeteATerceroLarga => 'Ça ne colle pas ?\nAjoute une troisième équipe';
  @override
  String get anadirEquipoBtn => 'Ajouter une équipe';
  @override
  String get tocaParaElegirJugadoresOPicks => 'Touche pour choisir\ndes joueurs ou des choix';

  @override
  String get mercadoCerradoNoSeBuscan => 'Le marché est fermé : la date limite des échanges est passée. Impossible de chercher des opérations avant l\'année prochaine.';
  @override
  String get ultimoAnioMinuscula => 'dernière année';

  @override
  String get tituloLegado => 'Héritage';
  @override
  String get explicacionPuntuacionCarreraTooltip => 'Ce que signifie le score de carrière';
  @override
  ...
  @override
  String get todaviaNoHayEstadisticas => 'Pas encore de statistiques à afficher.';
  @override
  String noSePudieronCargarCamisetas(String error) => 'Impossible de charger les maillots retirés.\n$error';
  @override
  String get todaviaNoHayCamisetaEnLiga => 'Aucun maillot n\'a encore été retiré dans la ligue. Quand une légende prendra sa retraite, tu pourras l\'honorer.';
  @override
  String get franquiciaLabel => 'Franchise';
  @override
  String get todaLaLigaOpcion => 'Toute la ligue';
  @override
  String equipoTodaviaNoHaRetirado(String equipo) => '$equipo n\'a encore retiré aucun maillot.';
  @override
  String get tuEquipoBadge => 'TON ÉQUIPE';
  @override
  String get retiradaRealDeLaFranquicia => 'Retrait réel de la franchise';
  @override
  String retiradaEnLaTemporada(String etiquetaTemporada) => 'Retirée en $etiquetaTemporada';
  @override
  ...
  @override
  String noSePudieronCargarPremios(String error) => 'Impossible de charger les trophées.\n$error';
  @override
  String get verCalendarioBtn => 'Voir le calendrier';
  @override
  String statsPremioLinea(String pts, String ast, String reb) => '$pts pts, $ast pd, $reb reb';

  @override
  String temporadaN(int n) => 'Saison $n';
  @override
  String arrancaLaTemporada(int n, int anioInicio, int anioFin) => 'La saison $n démarre ($anioInicio-$anioFin)';
  @override
  String get plantillaHaCambiadoAviso => 'Ton effectif a changé : vérifie-le avant le premier match — un alignement automatique a été préparé.';
  @override
  String get tusEleccionesDelDraft => 'Tes choix de draft';
  @override
  String get seRetiranDeTuEquipo => 'Prennent leur retraite de ton équipe';
  @override
  String cuelgaLasBotasCon(int edad, int media) => 'Prend sa retraite à $edad ans, niveau $media';
  @override
  ...
  @override
  String recibeA(String equipoA, String jugadorB, String posicionB) => '$equipoA récupère $jugadorB ($posicionB)';
  @override
  String get tambienSeRetiran => 'Prennent aussi leur retraite';
  @override
  String yNMas(int n) => 'et $n autres';
  @override
  String posicionMediaSeparador(String posicion, int media) => '$posicion · niveau $media · ';
  ...
  @override
  String posicionEdadMedia(String posicion, int edad, int media) => '$posicion · $edad ans · niveau $media';

  @override
  String cuartosCopaSeSiembranAviso(String nbaCup) => 'Les quarts de finale de la $nbaCup sont établis dès que la phase de groupes de toute la ligue est terminée.';
  @override
  String get finalSeJuegaDesdeCalendarioAviso => 'La finale se joue depuis le calendrier : si tu es finaliste, elle est indiquée comme un jour de plus de ta saison.';
  @override
  ...
  @override
  String noSePudoCargarResumen(String error) => 'Impossible de charger le résumé.\n$error';
  @override
  String temporadaConEtiqueta(String etiqueta) => 'Saison $etiqueta';
  @override
  String get pestanaBalance => 'Bilan';
  @override
  String puestoEnConferencia(String conferencia) => 'Position à l\'$conferencia';
  @override
  ...
  @override
  String partidosJugadosVictoriasPct(int partidos, int pct) => '$partidos matchs · $pct% de victoires';
  @override
  String get todaviaNoHayClasificacion => 'Pas encore de classement.';
  @override
  String get columnaPJ => 'MJ';
  @override
  String posicionMedia(String posicion, int media) => '$posicion · niveau $media';

  @override
  String get allStarSubtituloPendiente => 'Se joue pendant la pause de février. Simule jusqu\'au week-end des étoiles pour le voir.';
  @override
  String get risingStarsSubtituloPendiente => 'Les meilleurs rookies contre les joueurs de deuxième année, le même week-end.';
  @override
  String get votacionAbreCuandoRuedeBalonAviso => 'Le vote ouvre dès le coup d\'envoi. Au fil des journées jouées, tu verras qui gagne sa place et par combien de voix.';
  @override
  String get verEstadisticasBtn => 'Voir les statistiques';
  @override
  String mvpConNombre(String nombre) => 'MVP · $nombre';
  @override
  String lineaMvpPtsAstReb(int pts, int ast, int reb) => '$pts pts · $ast pd · $reb reb';
  @override
  ...
  @override
  String votacionAbiertaConPorcentaje(int pct) => 'Vote ouvert, avec $pct% de la saison jouée. Continue à simuler et les voix évolueront.';
  @override
  String get votacionFinalLabel => 'Vote final';
  @override
  String get votacionDeAficionadosLabel => 'Vote des supporters';
  @override
  String conferenciaConNombre(String conferenciaLabel) => 'Conférence $conferenciaLabel';
  @override
  ...
  @override
  String posicionValoracion(String posicion, String valoracion) => '$posicion · note de $valoracion';

  @override
  String get noLlegoACompletarNingunaTemporada => 'N\'a jamais terminé une saison complète avec toi.';
  @override
  ...
  @override
  String get sinTitulosNiPremiosCarreraNba => 'Aucun titre ni trophée dans sa carrière NBA.';
  @override
  String get sinTitulosNiPremiosIndividuales => 'Aucun titre ni trophée individuel.';
  @override
  String resumenCarreraTotales(int temporadas, String posicion, int partidos) => '$temporadas saisons · $posicion · $partidos matchs';
  @override
  String totalesCarreraLinea(String pts, String ast, String reb) => 'Totaux : $pts pts · $ast pd · $reb reb';
  @override
  String temporadasPreviasAviso(int n) => '$n d\'entre elles avant que tu ne prennes les commandes : pas de statistiques pour celles-là, les moyennes ci-dessous sont celles de ton ère.';
  @override
  String get antesDeTuPartidaTitulo => 'Avant ta partie';
  @override
  String temporadasYaJugadasCuandoCogisteElEquipo(int n) => '$n ${n == 1 ? 'saison' : 'saisons'} déjà jouées avant que tu prennes l\'équipe en main.';
  @override
  String get produccionDeReferenciaAviso => 'Sa production de référence au début de la partie. Il n\'y a pas de statistiques match par match pour ces années-là.';
  @override
  String sinEstadisticasDeCarreraAviso(String nombre) => 'Il n\'y a pas de statistiques de carrière pour $nombre : il vient d\'une époque antérieure à celle couverte par les données du jeu. Sa place dans l\'histoire existe, les chiffres non.';
  @override
  String get suCarreraEnLaNbaReal => 'Sa carrière dans la vraie NBA';
  @override
  String conEquipoEnLaNbaReal(String equipo) => 'Avec $equipo dans la vraie NBA';
  @override
  String temporadasPartidos(int temporadas, int partidos) => '$temporadas saisons · $partidos matchs';
  @override
  String rangoTemporadasPartidos(String desde, String hasta, int partidos) => '$desde à $hasta · $partidos matchs';
  @override
  String rangoPartidos(String rango, int partidos) => '$rango · $partidos matchs';
  @override
  String temporadaMinuscula(int n) => 'saison $n';

  @override
  String get nadieTePropuestoNadaAhora => 'Personne ne t\'a rien proposé pour l\'instant';
  @override
  String get unEquipoQuiereAUnoDeTusJugadores => 'Une équipe veut l\'un de tes joueurs';
  @override
  String nEquiposHanPreguntado(int n) => '$n équipes se sont renseignées sur tes joueurs';
  @override
  String cuadroYResultadosDeLaCopa(String nbaCup) => 'Tableau et résultats de la $nbaCup';
  @override
  String get seDesbloqueaAlTerminarFaseDeGrupos => 'Se débloque à la fin de la phase de groupes';
  @override
  String get premiosDeFinDeTemporadaSubtitulo => 'Trophées de fin de saison';
  @override
  String get seDesbloqueaAlTerminarTemporadaRegular => 'Se débloque à la fin de la saison régulière';
  @override
  String get bracketDeEliminatorias => 'Tableau des séries éliminatoires';
  @override
  String hallOfFameYCamisetasRetiradasSubtitulo(String hallOfFame, String camisetas) => '$hallOfFame et $camisetas';
  @override
  ...
  @override
  String get enQueRanuraQuieresEmpezar => 'Dans quel emplacement veux-tu commencer ?';
  @override
  String get eligeLaPartidaQueQuieresCargar => 'Choisis la partie que tu veux charger';
  @override
  ...
  @override
  String get sePerderaEnteraAviso => 'Cet emplacement a déjà une carrière en cours et elle sera entièrement perdue : effectifs, calendrier et palmarès. C\'est irréversible.';
  @override
  ...
  @override
  String sePierdeCarreraDeAviso(String nombre) => 'Toute la carrière de $nombre sera perdue : effectifs, calendrier, palmarès, légendes et maillots retirés. C\'est irréversible.';
  @override
  String get borrarBtn => 'Supprimer';
  @override
  String get lasTresRanurasOcupadasAviso => 'Les trois emplacements sont occupés : supprime-en un pour recommencer, ou continue l\'un de ceux que tu as déjà.';
  @override
  ...
  @override
  String sinPatrocinioFirmado(int ofertas) => ofertas == 1 ? 'Non signé · 1 offre' : 'Non signé ·  offres';
  @override
  ...
  @override
  String get patrocinadoresBloqueados => 'Les sponsors font partie de la version complète. Regarde une vidéo et tu as les quatre pour cette saison.';
  @override
  String get verVideoPatrocinadores => 'REGARDER LA VIDÉO ET DÉBLOQUER';
  @override
  String get videoSinTerminar => "La vidéo n'a pas été regardée en entier, ils restent donc bloqués. Tu peux réessayer.";
}
