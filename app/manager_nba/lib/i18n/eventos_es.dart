...
class EventosEs extends TextosDeEventos {
  ...
  Map<String, TextoDeEvento> get eventos => const {
        'cena_de_equipo': TextoDeEvento(
          ...
          texto: 'Los veteranos quieren organizar una cena para toda la '
        ...
        'bronca_en_el_entrenamiento': TextoDeEvento(
          ...
          texto: 'Dos jugadores han pasado de las palabras a los empujones en '
        ...
        'estrella_pide_descanso': TextoDeEvento(
          ...
          texto: 'Lleva jugando con molestias desde noviembre. No está '
        ...
        'joven_pide_minutos': TextoDeEvento(
          ...
          texto: 'Uno de tus chavales lleva media temporada pegado al '
        ...
        'aficion_llena_el_pabellon': TextoDeEvento(
          ...
          texto: 'Las entradas se están agotando y la afición pide un gesto: '
        ...
        'acto_publicitario': TextoDeEvento(
          ...
          texto: 'Una marca de la ciudad pone dinero encima de la mesa por un '
        ...
        'partido_benefico': TextoDeEvento(
          ...
          texto: 'El ayuntamiento organiza un amistoso benéfico y quiere al '
        ...
        'viaje_infernal': TextoDeEvento(
          ...
          texto: 'El calendario ha dejado un viaje muy duro. El preparador '
        ...
        'recta_final': TextoDeEvento(
          ...
          texto: 'Quedan pocos partidos y todo está apretado. El cuerpo '
        ...
        'rumor_de_traspaso': TextoDeEvento(
          titulo: 'Ha leído su nombre en los rumores',
          texto: 'Un periodista ha publicado que estás escuchando ofertas por '
              'uno de tus titulares. Te lo pregunta a la cara, delante de '
              'medio vestuario.',
          opciones: {
        ...
        'tanking_de_la_directiva': TextoDeEvento(
          ...
          texto: 'Las cuentas no dan para playoffs y arriba prefieren caer bajo '
        ...
        'jugador_llega_tarde': TextoDeEvento(
          titulo: 'Uno llega tarde otra vez',
          texto: 'Tercera vez este mes que aparece con el entrenamiento '
        ...
        'camiseta_de_una_leyenda': TextoDeEvento(
          ...
          texto: 'El club quiere subir su camiseta al techo del pabellón esta '
        ...
        'entrenador_pide_mando': TextoDeEvento(
          ...
          texto: 'Pide decidir él la rotación y los minutos, sin que nadie de '
        ...
        'metida_de_pata_en_redes': TextoDeEvento(
          titulo: 'Un jugador la ha liado en redes',
          texto: 'Ha publicado de madrugada que los árbitros van a por él. Lo '
        ...
        'precio_de_las_entradas': TextoDeEvento(
          ...
          texto: 'El equipo va bien, el pabellón se llena y la propiedad ve el '
        ...
        'nutricionista': TextoDeEvento(
          ...
          texto: 'Propone rehacer la comida del club de arriba abajo: menús '
