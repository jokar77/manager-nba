...
class EventosDe extends TextosDeEventos {
  ...
  Map<String, TextoDeEvento> get eventos => const {
        'cena_de_equipo': TextoDeEvento(
          ...
          texto: 'Die Routiniers wollen ein Essen für den ganzen Kader '
        ...
        'bronca_en_el_entrenamiento': TextoDeEvento(
          ...
          texto: 'Zwei Spieler sind bei einem Fünf-gegen-fünf von Worten zu '
        ...
        'estrella_pide_descanso': TextoDeEvento(
          titulo: 'Dein bester Spieler bittet um Pause',
          texto: 'Er spielt seit November mit Beschwerden. Verletzt ist er '
        ...
        'joven_pide_minutos': TextoDeEvento(
          titulo: 'Ein Junger will Spielzeit',
          texto: 'Einer deiner Jungen klebt seit einer halben Saison auf der '
        ...
        'prensa_dura': TextoDeEvento(
          ...
          texto: 'Nach der letzten Niederlage hat die Stadtzeitung geschrieben, '
        ...
        'racha_buena': TextoDeEvento(
          ...
          texto: 'Die Mannschaft läuft und man redet schon von euch als '
        ...
        'aficion_llena_el_pabellon': TextoDeEvento(
          ...
          texto: 'Die Tickets gehen weg und die Fans wollen eine Geste: ein '
        ...
        'acto_publicitario': TextoDeEvento(
          ...
          texto: 'Eine Marke aus der Stadt legt Geld auf den Tisch für einen '
        ...
        'partido_benefico': TextoDeEvento(
          ...
          texto: 'Die Stadt organisiert ein Benefiz-Freundschaftsspiel und will '
        ...
        'viaje_infernal': TextoDeEvento(
          ...
          texto: 'Der Spielplan hat euch eine brutale Reise beschert. Der '
        ...
        'veterano_de_vestuario': TextoDeEvento(
          titulo: 'Ein Routinier will mit der Mannschaft reden',
          texto: 'Der Älteste im Kader bittet dich um fünf Minuten mit dem '
              'Team, ohne Trainerstab im Raum. Er sagt, manche Dinge bespreche '
              'man besser unter Spielern.',
          opciones: {
        ...
        'recta_final': TextoDeEvento(
          ...
          texto: 'Es sind nur noch wenige Spiele und alles ist eng. Der Stab '
        ...
        'rumor_de_traspaso': TextoDeEvento(
          titulo: 'Er hat seinen Namen in den Gerüchten gelesen',
          texto: 'Ein Journalist hat geschrieben, dass du Angebote für einen '
              'deiner Starter anhörst. Er fragt dich direkt, vor der halben '
              'Kabine.',
          opciones: {
        ...
        'tanking_de_la_directiva': TextoDeEvento(
          ...
          texto: 'Für die Playoffs reicht es rechnerisch nicht, und oben wäre '
        ...
        'jugador_llega_tarde': TextoDeEvento(
          titulo: 'Einer kommt schon wieder zu spät',
          texto: 'Zum dritten Mal in diesem Monat steht er erst da, als das '
        ...
        'camiseta_de_una_leyenda': TextoDeEvento(
          ...
          texto: 'Der Klub will sein Trikot noch in dieser Saison aufhängen. '
        ...
        'entrenador_pide_mando': TextoDeEvento(
          ...
          texto: 'Er will Rotation und Minuten selbst bestimmen, ohne dass ihm '
        ...
        'metida_de_pata_en_redes': TextoDeEvento(
          titulo: 'Ein Spieler hat es in den sozialen Medien verbockt',
          texto: 'Er hat um drei Uhr nachts gepostet, die Schiedsrichter hätten '
        ...
        'precio_de_las_entradas': TextoDeEvento(
          ...
          texto: 'Die Mannschaft läuft, die Halle ist voll, und die Eigentümer '
        ...
        'nutricionista': TextoDeEvento(
          ...
          texto: 'Er will die Verpflegung des Klubs von Grund auf neu machen: '
