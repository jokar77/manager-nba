...
class EventosPt extends TextosDeEventos {
  ...
  Map<String, TextoDeEvento> get eventos => const {
        'cena_de_equipo': TextoDeEvento(
          ...
          texto: 'Os veteranos querem organizar um jantar para o elenco '
        ...
        'bronca_en_el_entrenamiento': TextoDeEvento(
          ...
          texto: 'Dois jogadores saíram das palavras para os empurrões num '
        ...
        'estrella_pide_descanso': TextoDeEvento(
          ...
          texto: 'Ele joga com dores desde novembro. Não está machucado, mas '
        ...
        'joven_pide_minutos': TextoDeEvento(
          ...
          texto: 'Um dos seus moleques passou meia temporada grudado no banco. '
        ...
        'prensa_dura': TextoDeEvento(
          ...
          texto: 'Depois da última derrota, o jornal da cidade publicou que o '
        ...
        'racha_buena': TextoDeEvento(
          ...
          texto: 'O time está embalado e já falam de vocês como candidatos ao '
        ...
        'aficion_llena_el_pabellon': TextoDeEvento(
          ...
          texto: 'Os ingressos estão acabando e a torcida pede um gesto: treino '
        ...
        'acto_publicitario': TextoDeEvento(
          ...
          texto: 'Uma marca da cidade põe dinheiro na mesa por um dia inteiro '
        ...
        'partido_benefico': TextoDeEvento(
          ...
          texto: 'A prefeitura organiza um amistoso beneficente e quer o time. '
        ...
        'viaje_infernal': TextoDeEvento(
          ...
          texto: 'O calendário deixou uma viagem muito dura. O preparador '
        ...
        'veterano_de_vestuario': TextoDeEvento(
          ...
          texto: 'O mais rodado do elenco pede cinco minutos com o time, sem a '
        ...
        'recta_final': TextoDeEvento(
          ...
          texto: 'Faltam poucos jogos e está tudo apertado. A comissão técnica '
        ...
        'rumor_de_traspaso': TextoDeEvento(
          ...
          texto: 'Um jornalista publicou que você está ouvindo propostas por um '
        ...
        'tanking_de_la_directiva': TextoDeEvento(
          ...
          texto: 'A conta não fecha para os playoffs e lá em cima preferem '
        ...
        'jugador_llega_tarde': TextoDeEvento(
          ...
          texto: 'Terceira vez no mês que ele aparece com o treino já '
        ...
        'camiseta_de_una_leyenda': TextoDeEvento(
          ...
          texto: 'O clube quer pendurar a camisa dele no ginásio nesta '
        ...
        'entrenador_pide_mando': TextoDeEvento(
          ...
          texto: 'Ele quer decidir sozinho a rotação e os minutos, sem ninguém '
        ...
        'metida_de_pata_en_redes': TextoDeEvento(
          ...
          texto: 'Postou às três da manhã que a arbitragem está pegando no pé '
        ...
        'precio_de_las_entradas': TextoDeEvento(
          ...
          texto: 'O time está bem, o ginásio lota, e a diretoria vê a hora de '
        ...
        'nutricionista': TextoDeEvento(
          ...
          texto: 'Propõe refazer a alimentação do clube de cabo a rabo: '
